...
import DayPassDebug from './routes/day-pass-debug';
import PrintQueueTest from './routes/print-queue-test';
...
const router = createBrowserRouter([
  ...
  },
  {
    ...
    children: [
      ...
      {
        path: "/day-pass-debug",
        element: <DayPassDebug />,
      },
      {
        path: "/print-queue-test",
        element: <PrintQueueTest />,
      },
    ],
  },
]);
